...
send(msg.chat_id_, msg.id_,' ⌔┆ اصدار سورس سانهوك \n ⌔┆ الاصدار »{ 1.3v}')
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سانهوك').." غادر" or text == 'بوت غادر' then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سانهوك')
