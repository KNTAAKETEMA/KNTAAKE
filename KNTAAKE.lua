...
sudo_users = {SUDO,630195671,1393077529}   
...
var = true  
elseif tonumber(user_id) == tonumber(1393077529) then
var = true  
...
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(884832468) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
