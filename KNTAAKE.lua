...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/KNTAAKETEAM/Files_KNTAAKE/master/File_Bot/commands.lua") 
...
local hash = database:sismember(bot_id.."VVv59vV:MN:TF"..msg.chat_id_,msg.sender_user_id_)
if hash or SudoBot(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg)  then    
return true    
else    
return false    
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/KNTAAKETEAM/Files_KNTAAKE/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/KNTAAKETEAM/Files_KNTAAKE/master/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌔┆ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'X_MIKEY')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌔┆ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'X_MIKEY')..')'
...
if not database:get(bot_id..'Vv59vV:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:sadd(bot_id.."Vv59vV:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."Vv59vV:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "⌁︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."Vv59vV:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."Vv59vV:allM"..msg.chat_id_)
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'كنتاكي').." غادر" or text == 'بوت غادر' then  
