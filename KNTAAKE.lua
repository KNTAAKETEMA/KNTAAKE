...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./KNTAAKE.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("KA", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S KNTAAKE -X kill
screen -S KNTAAKE ./KNTAAKE
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/KNTAAKETEMA/KNTAAKE/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,884832468,694635826}   
...
if hash or SudoBot(msg) or DevKNTAAKEW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevKNTAAKEW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKNTAAKEW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKNTAAKEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."VV59VV:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevKNTAAKEW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
if hash or SudoBot(msg) or DevKNTAAKEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKNTAAKEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(884832468) then  
var = true  
elseif tonumber(user_id) == tonumber(694635826) then
var = true 
...
var = true
elseif database:sismember(bot_id..'VV59VV:MN:TF'..chat_id, user_id) then
var = true  
...
local KNTAAKE_Msg = ''  
if msgs < 100 then 
KNTAAKE_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
KNTAAKE_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
KNTAAKE_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
KNTAAKE_Msg = 'متفاعل' 
elseif msgs < 1200 then 
KNTAAKE_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
KNTAAKE_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
KNTAAKE_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
KNTAAKE_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
KNTAAKE_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
KNTAAKE_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
KNTAAKE_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KNTAAKE_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
KNTAAKE_Msg = 'رب التفاعل'  
end 
return KNTAAKE_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@X_MIKEY")  
...
--------------------------------------------------------------------------------------------------------------
function SourceKNTAAKE(msg,data) -- بداية العمل
if msg then
...
if not DevKNTAAKEW(msg)  and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevKNTAAKEW(msg)  and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,KNTAAKE_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⌁' and DevKNTAAKEW(msg)  then  
...
if text == 'تعطيل التواصل ⌁' and DevKNTAAKEW(msg)  then  
...
if text == 'تفعيل البوت الخدمي ⌁' and DevKNTAAKEW(msg)  then  
...
if text == 'تعطيل البوت الخدمي ⌁' and DevKNTAAKEW(msg)  then  
...
if text == 'ضع كليشه ستارت ⌁' and DevKNTAAKEW(msg)  then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ⌁︙ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ⌁' and DevKNTAAKEW(msg)  then 
...
if text == 'تحديث السورس ⌁' and DevKNTAAKEW(msg)  then 
os.execute('rm -rf KNTAAKE.lua')
os.execute('wget https://raw.githubusercontent.com/KNTAAKETEMA/KNTAAKE/master/KNTAAKE.lua')
send(msg.chat_id_, msg.id_,' ⌁︙ تم تحديث السورس \n ⌁︙ لديك اخر اصدار لسورس كنتاكي\n ⌁︙ الاصدار » { 1.3v}')
dofile('KNTAAKE.lua')  
end
if text == 'الاصدار ⌁' and DevKNTAAKEW(msg)  then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌁︙ اصدار سورس كنتاكي \n ⌁︙ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ⌁' and DevKNTAAKEW(msg)  then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌁︙ [تحديثات البوت](t.me/KNTAAKE) \n ⌁︙ [قناه السورس](t.me/KNTAAKE)')
end
if text == "ضع اسم للبوت ⌁" and DevKNTAAKEW(msg)  then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ⌁︙ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ⌁' and DevKNTAAKEW(msg)  then 
...
if text == 'المشتركين ⌁' and DevKNTAAKEW(msg)  then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ⌁︙ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌁' and DevKNTAAKEW(msg)  then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ⌁︙ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌁") and DevKNTAAKEW(msg)  then
...
if text == ("قائمه العام ⌁") and DevKNTAAKEW(msg)  then
...
if text == ("قائمه الكتم العام ⌁") and DevKNTAAKEW(msg)  then
...
if text=="اذاعه خاص ⌁" and msg.reply_to_message_id_ == 0 and DevKNTAAKEW(msg)  then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁︙ ارسل الان اذاعتك؟ \n ⌁︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ⌁" and msg.reply_to_message_id_ == 0 and DevKNTAAKEW(msg)  then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁︙ ارسل الان اذاعتك؟ \n ⌁︙ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ⌁" and msg.reply_to_message_id_ == 0 and DevKNTAAKEW(msg)  then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁︙ ارسل الان اذاعتك؟ \n ⌁︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ⌁" and msg.reply_to_message_id_ == 0  and DevKNTAAKEW(msg)  then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁︙ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌁" and msg.reply_to_message_id_ == 0  and DevKNTAAKEW(msg)  then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁︙ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌁' and DevKNTAAKEW(msg)  then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌁" and DevKNTAAKEW(msg)  then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌁" and DevKNTAAKEW(msg)  then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'⌁︙  عدد الكروبات الان » { '..#group..' }'..KNTAAKEk..''..KNTAAKE..'\n⌁︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevKNTAAKEW(msg)  then
...
if text and text:match("^رفع مطور (%d+)$") and DevKNTAAKEW(msg)  then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevKNTAAKEW(msg)  then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevKNTAAKEW(msg)  then
...
local KNTAAKE1_Msg = database:get(bot_id.."KNTAAKE1:Add:Filter:Rp2"..text..msg.chat_id_)   
if KNTAAKE1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌁︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KNTAAKE')..') \n ⌁︙ '..KNTAAKE1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if KNTAAKE_Msg and not Special(msg) then  
local KNTAAKE_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KNTAAKE_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌁︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌁︙ ["..KNTAAKE_Msg.."] \n")
else
send(msg.chat_id_,0," ⌁︙ العضو : {["..data.first_name_.."](T.ME/KNTAAKE)}\n ⌁︙ ["..KNTAAKE_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⌁︙ عذرا » {["..data.first_name_.."](T.ME/KNTAAKE)}\n ⌁︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevKNTAAKEW(msg)  then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevKNTAAKEW(msg)  then
...
if text and text:match("^تغير الاشتراك$") and DevKNTAAKEW(msg)  then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌁︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevKNTAAKEW(msg)  then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌁︙ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ⌁" and DevKNTAAKEW(msg)  then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ⌁︙ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌁$") and DevKNTAAKEW(msg)  then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌁︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌁" and DevKNTAAKEW(msg)  then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌁" and DevKNTAAKEW(msg)  then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ⌁︙ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ⌁" and DevKNTAAKEW(msg)  then  
...
database:sadd(bot_id.."KNTAAKE:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."KNTAAKE:blocname"..msg.chat_id_)
...
function Vv59vV_name(t1,t2)
if t2.id_ then 
name_Kntaake = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Kntaake then 
names_Kntaake = database:smembers(bot_id.."KNTAAKE:blocname"..msg.chat_id_) or ""
if names_Kntaake and names_Kntaake[1] then 
for i=1,#names_Kntaake do 
if name_Kntaake:match("(.*)("..names_Kntaake[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, Vv59vV_name)
end
...
database:set(bot_id.."KNTAAKE:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."KNTAAKE:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."KNTAAKE:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."KNTAAKE:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."KNTAAKE:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_KNTAAKEa_new(KNTAAKE1,KNTAAKE2)
if KNTAAKE2 and KNTAAKE2.first_name_ then 
if KNTAAKE2.first_name_:match("(.*)"..database:get(bot_id.."KNTAAKE:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."KNTAAKE:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local KNTAAKE_nnn = database:get(bot_id.."KNTAAKE:nump"..msg.chat_id_) or 5
local KNTAAKE_nnn2 = database:get(bot_id.."KNTAAKE:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(KNTAAKE_nnn2) == tonumber(KNTAAKE_nnn) or tonumber(KNTAAKE_nnn2) > tonumber(KNTAAKE_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."KNTAAKE:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌁︙عزيزي >>["..KNTAAKE2.username_.."](https://t.me/"..(KNTAAKE2.username_ or "pvv_v")..")\n⌁︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."KNTAAKE:teh"..msg.chat_id_).."} بجانب اسمك\n⌁︙عدد المحاولات المتبقيه {"..(tonumber(KNTAAKE_nnn) - tonumber(KNTAAKE_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_KNTAAKEa_new)
end
end
...
local KNTAAKEChengName = database:get(bot_id.."KNTAAKE:Cheng:Name"..data.id_)
if not data.first_name_ then 
if KNTAAKEChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..KNTAAKEChengName..']')
database:del(bot_id.."KNTAAKE:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if KNTAAKEChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."KNTAAKE:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local KNTAAKEChengUserName = database:get(bot_id.."KNTAAKE:Cheng:UserName"..data.id_)
if not data.username_ then 
if KNTAAKEChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..KNTAAKEChengUserName..']')
database:del(bot_id.."KNTAAKE:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if KNTAAKEChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."KNTAAKE:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local KNTAAKEChengPhoto = database:get(bot_id.."KNTAAKE:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if KNTAAKEChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."KNTAAKE:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if KNTAAKEChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."KNTAAKE:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
⧉️↬𝐊𝐍𝐓𝐀𝐊 𝐓𝐄𝐀𝐌
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⧉️↬[𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒌𝒏𝒕𝒂𝒌](https://t.me/KNTAAKE)

⧉️↬[𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑¹](https://t.me/Vv59vV)

⧉️↬[𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑²](https://t.me/X_MIKEY)

⧉️↬[𝐓𝐨 𝐭𝐚𝐥𝐤 𝐭𝐨 𝐮𝐬](https://t.me/KNTAKEBOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevKNTAAKEW(msg)  then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⌁︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KNTAAKE')..') \n ⌁︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌁︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'KNTAAKE')..') \n ⌁︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevKNTAAKEW(msg)  then    
dofile('KNTAAKE.lua')  
send(msg.chat_id_, msg.id_, ' ⌁︙ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevKNTAAKEW(msg)  then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevKNTAAKEW(msg)  then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevKNTAAKEW(msg)  then
...
if text and text:match("^حظر عام (%d+)$") and DevKNTAAKEW(msg)  then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevKNTAAKEW(msg)  then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevKNTAAKEW(msg)  then
...
if text and text:match("^كتم عام (%d+)$") and DevKNTAAKEW(msg)  then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevKNTAAKEW(msg)  then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevKNTAAKEW(msg)  then
...
if text and text:match("^الغاء العام (%d+)$") and DevKNTAAKEW(msg)  then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevKNTAAKEW(msg)  then
...
if database:get(bot_id.."VV59VV:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'VV59VV:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."VV59VV:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'VV59VV:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevKNTAAKEW(msg)  then
t = ' ⌁︙ ملفات السورس كنتاكي ↓\n『─────·𖤐·─────』 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevKNTAAKEW(msg)  then
local Get_Files, res = https.request("https://raw.githubusercontent.com/KNTAAKETEMA/KNTAAKE/master/File_Bot/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⌁︙ اهلا بك في متجر ملفات كنتاكي\n ⌁︙ ملفات السورس ↓\n『─────·𖤐·─────』\n\n"
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevKNTAAKEW(msg)  then
...
local json_file, res = https.request("https://raw.githubusercontent.com/KNTAAKETEMA/KNTAAKE/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('KNTAAKE.lua')  
else
send(msg.chat_id_, msg.id_," ⌁︙ عذرا الملف لايدعم سورس كنتاكي \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevKNTAAKEW(msg)  then
...
if text == "مسح الملفات" and DevKNTAAKEW(msg)  then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ⌁︙ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevKNTAAKEW(msg)  then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevKNTAAKEW(msg)  then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "KNTAAKE")
...
function Function_KNTAAKE(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_KNTAAKE, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_KNTAAKE, nil)
return false 
end
...
database:sadd(bot_id..'VV59VV:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌁︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KNTAAKE')..')'
status  = '\n ⌁︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'VV59VV:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ⌁︙ العضو » ['..result.title_..'](t.me/'..(username or 'KNTAAKE')..')'
status  = '\n ⌁︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'VV59VV:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌁︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KNTAAKE')..')'
status  = '\n ⌁︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'VV59VV:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌁︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KNTAAKE')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'VV59VV:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ⌁︙ العضو » ['..result.title_..'](t.me/'..(username or 'KNTAAKE')..')'
status  = '\n ⌁︙ تم تنزيله من المنظفيه'
texts = usertext..status
else
...
database:srem(bot_id..'VV59VV:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌁︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KNTAAKE')..')'
status  = '\n ⌁︙ تم تنزيله من المنظفيه'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌁︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KNTAAKE')..')'
status  = '\n ⌁︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⌁︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌁︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KNTAAKE')..')'
...
database:set(bot_id.."KNTAAKE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."KNTAAKE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ⌁︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."KNTAAKE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."KNTAAKE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."KNTAAKE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."KNTAAKE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ⌁︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."KNTAAKE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."KNTAAKE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."KNTAAKE1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."KNTAAKE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⌁︙ ارسل الكلمه الان")  
database:set(bot_id.."KNTAAKE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."KNTAAKE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."KNTAAKE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KNTAAKE1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."KNTAAKE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."KNTAAKE1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."KNTAAKE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KNTAAKE1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."KNTAAKE1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ⌁︙ قائمة المنع \n『─────·𖤐·─────』\n"
for k,v in pairs(list) do  
local KNTAAKE_Msg = database:get(bot_id.."KNTAAKE1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..KNTAAKE_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevKNTAAKEW(msg)  then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ⌁︙ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevKNTAAKEW(msg)  then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌁︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'KNTAAKE')..')'..'\n ⌁︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevKNTAAKEW(msg)  then  
...
if text == 'تعطيل الاذاعه' and DevKNTAAKEW(msg)  then  
...
local num = database:smembers(bot_id.."VV59VV:MN:TF"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كنتاكي').."" then  
...
send(msg.chat_id_, msg.id_,'['..KNTAAKE_Msg[math.random(#KNTAAKE_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevKNTAAKEW(msg)  then 
...
if text == ("مسح ردود المطور") and DevKNTAAKEW(msg)  then 
...
if text == ("ردود المطور") and DevKNTAAKEW(msg)  then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌁︙ قائمة ردود المطور \n『─────·𖤐·─────』\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevKNTAAKEW(msg)  then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevKNTAAKEW(msg)  then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'كنتاكي').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevKNTAAKEW(msg)  then   
...
if text == 'تعطيل المغادره' and DevKNTAAKEW(msg)  then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'KNTAAKE')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
KNTAAKEdx(msg.chat_id_, msg.id_, ' ⌁︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ⌁︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ⌁︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ⌁︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevKNTAAKEW(msg)  then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'كنتاكي')
...
KNTAAKE = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KNTAAKE)
...
--------------------------------------------------------------------------------------------------------------
SourceKNTAAKE(data.message_,data)
...
------------------------------------------------------------------------
local KNTAAKEAbot = database:get(bot_id.."KNTAAKE1:Add:Filter:Rp2"..text..result.chat_id_)   
if KNTAAKEAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌁︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌁︙ ["..KNTAAKEAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local KNTAAKE1_Msg = database:get(bot_id.."KNTAAKE1:Add:Filter:Rp2"..text..result.chat_id_)   
if KNTAAKE1_Msg then    
send(msg.chat_id_, msg.id_," ⌁︙ "..KNTAAKE1_Msg)
